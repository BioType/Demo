...
function readDocument(imageArrayBuffer, width) {
    ...
    if(_PDFCONTENTS == null){
      fileReader.onload = async function(fileLoadedEvent) {
        ...
        if(width){
          signPDF(contents,certArrayBuffer,imageArrayBuffer,width)
        }else{
          signPDF(contents,certArrayBuffer,imageArrayBuffer)
        }
      }
      ...
      if(width){
        signPDF(_PDFCONTENTS,certArrayBuffer,imageArrayBuffer,width)
      }else{
        signPDF(_PDFCONTENTS,certArrayBuffer,imageArrayBuffer)
      }
    }
}
